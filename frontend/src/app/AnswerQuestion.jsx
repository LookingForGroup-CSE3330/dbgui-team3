    ...
    onAnswerAdd(){
        if(!localStorage.getItem('role')){
            ...
            if(this.state.answer.length >= 10){
                let newanswer = new Answer(post_id, parseInt(localStorage.getItem('currentid')), theDate, this.state.answer) //NEED TO ADD user_id (this is the id of the person,doc, answering the question) after post_id parameter
